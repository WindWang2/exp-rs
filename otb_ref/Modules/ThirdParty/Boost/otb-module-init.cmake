...
# SICNU GEO RS patch: When building as a subproject, Boost variables are
# pre-set by the parent CMakeLists.txt. Skip find_package(Boost REQUIRED)
# because CMake 4.x removed FindBoost.cmake and Boost doesn't ship BoostConfig.
if(NOT Boost_FOUND)
  ...
  message(STATUS "Boost already found ( Boost_INCLUDE_DIRS=${Boost_INCLUDE_DIRS} )")
endif()
if (BUILD_TESTING)
