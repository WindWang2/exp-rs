...
macro(otb_create_application)
  ...
  # SICNU: OTB app plugins use Boost.Filesystem transitively (VectorData/DEM);
  # ensure symbols resolve when parent static libs omit the dependency edge.
  if(TARGET Boost::filesystem)
    target_link_libraries(${APPLICATION_TARGET_NAME} Boost::filesystem)
  endif()
  if(TARGET Boost::serialization)
    target_link_libraries(${APPLICATION_TARGET_NAME} Boost::serialization)
  endif()
  if(otb-module)
...
macro(otb_write_app_launcher)
  # Produce vars APPLAUNCHER_NAME, APPLAUNCHER_OUTPUT, APPLAUNCHER_TYPE
...
if (Test-Path \"$PSScriptRoot\\${_launcher_type}.ps1\" -PathType Leaf) {
  $OTB_LAUNCHER = \"$PSScriptRoot\\${_launcher_type}.ps1\"
}
else {
