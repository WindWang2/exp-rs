...
//
//   gen-meta   Derive the v2 capability sidecars for all 115 rs: operators
...
int cmdGenMeta( const QString &root )
{
  ...
  if ( rsDescriptors.size() != 115 )
  {
    std::cerr << "gen-meta: expected 115 rs: descriptors, found " << rsDescriptors.size()
