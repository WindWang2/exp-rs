...
rem Default CSV lands NEXT TO the submissions folder (teacher expectation);
rem discovery skips it automatically when it lives inside that folder.
set "CSV=%~3"
if "%CSV%"=="" set "CSV=%~f1\grades.csv"
