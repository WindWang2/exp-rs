...
class QgsProcessingRegistry:
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._instance:
            cls._instance = super(QgsProcessingRegistry, cls).__new__(cls, *args, **kwargs)
            cls._instance.tools = {}
...
ToolRegistry = QgsProcessingRegistry

def register_tool(name: str = None, label: str = None, category: str = "Custom Tools", description: str = "", params: list = None):
    """
    Decorator to dynamically register a geospatial calculation function in QgsProcessingRegistry.
    ...
    def decorator(fn):
        ...
        QgsProcessingRegistry().register(tool_name, tool_label, category, tool_desc, tool_params, fn)
        return fn
    return decorator
