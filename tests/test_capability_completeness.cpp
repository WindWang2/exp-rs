...
const std::vector<std::pair<std::string, std::string>> kIoInputsExempt = {
    { "rs:cn_product_import", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:landsat_import", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:modis_georeference", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:modis_import", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:mosaic", "collection-style: inputs is an array-of-string path parameter" },
    { "rs:sar_temporal_events", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:sar_temporal_stats", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:sentinel2_import", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_anomaly", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_breakpoints", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_composite", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_decompose", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_extract_series", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_gap_fill", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_harmonic_fit", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_index_series", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_model_select", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_phenology_multi", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_seasonal_breaks", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_sen_trend", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_summary", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:temporal_trend", "collection-style: scene list is an array-of-string path parameter" },
    { "rs:zy3_import", "collection-style: scene list is an array-of-string path parameter" },
};
