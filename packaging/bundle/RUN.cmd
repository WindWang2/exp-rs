...
rem Runtime DLLs live next to the CLI (windeployqt output in bin\).
...
if exist "data\samples\landsat_sample.tif" (
  ...
  bin\sicnu_generate_samples.exe data\samples || exit /b 1
)
...
bin\sicnu_geo_rs_cli.exe --offline --pipeline "labs\lab1\lab1_ndvi.pipeline.json" || exit /b 1
