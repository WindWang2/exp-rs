...
cmake -S . -B build -G Ninja \
  ...
  -DWITH_QTWEBENGINE=OFF -DWITH_QTGAMEPAD=OFF -DFETCHCONTENT_SOURCE_DIR_PYBIND11=/home/kevin/projects/rs-studio/main/build/_deps/pybind11-src -DFETCHCONTENT_SOURCE_DIR_CATCH2=/home/kevin/projects/rs-studio/main/build/_deps/catch2-src \
  > "$LOG" 2>&1
CONF=$?
if [ $CONF -eq 0 ]; then
