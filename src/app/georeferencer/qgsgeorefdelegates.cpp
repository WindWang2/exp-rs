/***************************************************************************
     qgsgeorefdelegates.cpp - SICNU port of QGIS georef delegates
     --------------------------------------
...
// ---------------------------- RsGcpTypeDelegate -------------------------- //
RsGcpTypeDelegate::RsGcpTypeDelegate( QObject *parent )
  : QStyledItemDelegate( parent )
{}

QWidget *RsGcpTypeDelegate::createEditor( QWidget *parent, const QStyleOptionViewItem & /*option*/, const QModelIndex & /*index*/ ) const
{
...
void RsGcpTypeDelegate::setEditorData( QWidget *editor, const QModelIndex &index ) const
{
...
void RsGcpTypeDelegate::setModelData( QWidget *editor, QAbstractItemModel *model, const QModelIndex &index ) const
{
  auto *cb = qobject_cast<QComboBox *>( editor );
  if ( cb )
