  ...
  , mLayer( layer )
{
  ...
  mDockableWidgetHelper = new QgsDockableWidgetHelper( windowTitle(), this, QgisApp::instance()->mainWindow(), u"attribute-table"_s, QStringList(), openingMode, false, Qt::BottomDockWidgetArea );
