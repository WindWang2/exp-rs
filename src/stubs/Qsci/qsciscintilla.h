...
public:
    ...
    // Position-accurate line/index mapping (#651): one implementation lives
    // on the virtual surface — a private duplicate redeclared the same
    // signature and failed to compile.
