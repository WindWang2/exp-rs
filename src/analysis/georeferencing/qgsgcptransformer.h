 ...
 * \since QGIS 3.20
*/
class QGIS_ANALYSIS_EXPORT QgsGcpTransformerInterface
{
    Q_GADGET
  ...
  public:
     ...
     */
    virtual std::unique_ptr<QgsGcpTransformerInterface> clone() const = 0;
     ...
     */
    static std::unique_ptr<QgsGcpTransformerInterface> create( TransformMethod method );
 ...
 * \since QGIS 3.20
 */
class QGIS_ANALYSIS_EXPORT QgsLinearGeorefTransform : public QgsGcpTransformerInterface
{
  public:
 ...
 * \since QGIS 3.20
 */
class QGIS_ANALYSIS_EXPORT QgsHelmertGeorefTransform : public QgsGcpTransformerInterface
{
  public:
 ...
 * \since QGIS 3.20
 */
class QGIS_ANALYSIS_EXPORT QgsGDALGeorefTransform : public QgsGcpTransformerInterface
{
  public:
 ...
 * \since QGIS 3.20
 */
class QGIS_ANALYSIS_EXPORT QgsProjectiveGeorefTransform : public QgsGcpTransformerInterface
{
  public:
