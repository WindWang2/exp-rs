...
const char *const kFailureModeCodes[] = {
  ...
  "GRID_CRS_MISSING", "DEM_CRS_MISMATCH",
  "SCENE_TRUTH_INVALID", "ORBIT_SEGMENT_INVALID", "ORBIT_EPOCH_MISMATCH",
  "WAVELENGTH_INCOMPATIBLE", "BASELINE_NO_ZERO_DOPPLER_MASTER",
  "BASELINE_NO_ZERO_DOPPLER_SLAVE", "BASELINE_STATE_INTERPOLATION_FAILED",
  "DEM_GRID_UNSUPPORTED", "DEM_EXTENT_INSUFFICIENT",
  "TOPO_PHASE_METADATA_MISSING", "TOPO_PHASE_ORBIT_COVERAGE",
  "COREGISTRATION_FAILED", "PAIR_GRAPH_DISCONNECTED",
  "UNWRAP_PROVIDER_FAILED", "UNWRAP_PROVIDER_TIMEOUT",
  "UNWRAP_PROVIDER_INVALID_OUTPUT", "NETWORK_INVERSION_PATTERN_BLOWUP",
  "NETWORK_INVERSION_RANK_DEFICIENT", "NETWORK_INVERSION_PAIR_LIMIT",
  "NETWORK_INVERSION_EPOCH_LIMIT",
};
...
const std::map<std::string, std::string> &familyMap()
{
  static const std::map<std::string, std::string> kMap = {
    ...
    { "rs:temporal_model_select", "temporal" },
    ...
    { "rs:osp_detection", "hyperspectral" },
    { "rs:spectral_spatial_fuse", "hyperspectral" },
    { "rs:tcimf_detection", "hyperspectral" },
