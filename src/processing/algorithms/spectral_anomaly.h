...
namespace SpectralAnomaly
{
    ...
    /// provided and that band has declared NoData (@a hasNoDataBands) — within
    /// tolerance of that band's declared NoData value, so the mean reflects valid pixels only.
