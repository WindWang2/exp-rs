...
using ChangeDetectionMAD::chiSquareUpperCdf;
using ChangeDetectionMAD::madSqrtInv;
...
// madSqrtInv and chiSquareUpperCdf live in ir_mad_kernels.h (single owner;
// the streaming path calls the same compiled functions, which is what makes
// the bit-for-bit streaming parity possible).
